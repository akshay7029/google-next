...
export default function SearchHeaderOptions() {
  ...
  return (
    <div className='flex space-x-2 select-none border-b w-full justify-center lg:justify-start lg:pl-52 text-gray-700 text-sm'>
        <div onClick={() => selectTab("All")} className={`flex items-center space-x-1 border-transparent
            active:text-blue-500 cursor-pointer pb-3 px-2
            ${Pathname === '/search/web' && 'text-blue-600 !border-blue-600'}`}>
         <AiOutlineSearch />
         <p>All</p>
        </div>
        <div onClick={() => selectTab("Images")} className={`flex items-center space-x-1 border-transparent
            active:text-blue-500 cursor-pointer pb-3 px-2
